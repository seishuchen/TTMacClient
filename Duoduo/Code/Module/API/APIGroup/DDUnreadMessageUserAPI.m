...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint32_t seqNo)
    {
        ...
        [dataout writeTcpProtocolHeader:MODULE_ID_SESSION cId:CMD_MSG_UNREAD_CNT_REQ seqNo:seqNo];
        log4CInfo(@"serviceID:%i cmdID:%i --> get unread msg cnt",MODULE_ID_SESSION,CMD_MSG_UNREAD_CNT_REQ);

...
{
    return CMD_ID_GROUP_QUIT_GROUP_REQ;
}
...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint16_t seqNo)
    {
        ...
        uint32_t totalLen = IM_PDU_HEADER_LEN + 4 + strLen(groupId) + 4;
        ...
        [dataout writeTcpProtocolHeader:MODULE_ID_GROUP cId:CMD_ID_GROUP_QUIT_GROUP_REQ seqNo:seqNo];
        ...
        log4CInfo(@"serviceID:%i cmdID:%i --> change group member group ID:%@",MODULE_ID_GROUP,CMD_ID_GROUP_QUIT_GROUP_REQ,groupId);

...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint32_t seqNo)
    {
        ...
        [dataout writeTcpProtocolHeader:MODULE_ID_SESSION cId:CMD_MSG_READ_ACK seqNo:seqNo];
        [dataout writeUTF:object];
        
        log4CInfo(@"serviceID:%i cmdID:%i --> send msg read ack from userID:%@",MODULE_ID_SESSION,CMD_MSG_DATA_ACK,object);

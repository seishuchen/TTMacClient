...
- (id)init
{
    ...
    if (self)
    {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveUserLoginSuccess:) name:notificationUserLoginSuccess object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveUserReloginSuccess:) name:notificationUserReloginSuccess object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(receiveUserOfflineNotification:) name:notificationUserOffline object:nil];
...
- (void)updateUsersOnlineState:(NSArray*)userIDs
{
    ...
    if ([notExitUsers count] > 0)
    {
        [[DDLogic instance] pushTaskWithBlock:^{
            NSMutableData *data = [TcpProtocolPack getUserListOnlineState:notExitUsers];
...
//    [[NSNotificationCenter defaultCenter] removeObserver:self name:notificationUserLoginSuccess object:nil];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:notificationUserOffline object:nil];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:notificationUserReloginSuccess object:nil];
}
